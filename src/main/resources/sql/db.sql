...
CREATE TABLE IF NOT EXISTS `annotation` (
  ...
  `langA` varchar(3) COLLATE utf8_bin DEFAULT NULL COMMENT 'Language A (use ISO code of two digits when possible)',
  ...
  `templateA` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `templateB` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `attributeA` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `attributeB` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `propertyA` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `propertyB` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `classA` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `classB` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `propDomainA` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `propDomainB` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `propRangeA` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `propRangeB` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=18606 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
) ENGINE=InnoDB AUTO_INCREMENT=4694 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
